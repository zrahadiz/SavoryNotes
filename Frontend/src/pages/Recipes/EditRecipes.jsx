...
export default function EditRecipePage() {
  ...
  const fetchRecipe = async () => {
    ...
    try {
      ...
      const recipe = data.payload.datas;
  ...
  const handleSubmit = async (e) => {
    ...
    setLoadingState(true);
    setLoadingText("Updating the recipe...");
    try {
      ...
      const { data } = await api.put(`/posts/${slug}`, submissionData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      console.log("Recipe updated:", data.payload.datas);
    ...
    <div className="min-h-screen bg-linear-to-b from-white to-green-50">
      ...
      <div className="bg-linear-to-r from-secondary to-orange-600 text-white py-8 sm:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold">Edit Recipe</h1>
          <p className="text-orange-100 mt-2">Update your recipe details</p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="input w-full rounded-xl border-2 border-gray-200 focus:border-secondary outline-none transition"
                required
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                rows="3"
                className="textarea w-full rounded-xl border-2 border-gray-200 focus:border-secondary outline-none transition"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="select w-full  border-2 border-gray-200 rounded-xl focus:border-secondary outline-none cursor-pointer"
                  required
                >
                  {categories.map((cat) => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  min="0"
                  className="input w-full border-2 border-gray-200 rounded-xl focus:border-secondary outline-none transition"
                />
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="flex gap-2 mb-4">
              <input
                ...
                className="input flex-1 border-2 border-gray-200 rounded-xl focus:border-secondary outline-none transition"
              />
              <button
                type="button"
                ...
                {formData.ingredients.map((ingredient, index) => (
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <HiCheck className="w-5 h-5 text-secondary" />
                      {ingredient}
                    </span>
                    <button
                      type="button"
