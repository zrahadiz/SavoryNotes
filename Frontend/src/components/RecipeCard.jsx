            ...
            <div className="flex justify-between mt-2 gap-2">
              {showEdit && (
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 py-2 rounded-full font-semibold border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white transition cursor-pointer"
                >
                  <HiPencil className="w-4 h-4" /> Edit
                </button>
              )}
              {showDelete && (
                <button className="flex-1 flex items-center justify-center gap-1 py-2 rounded-full font-semibold border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white transition cursor-pointer">
